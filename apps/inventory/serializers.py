...
class ReceiptSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Receipt
        fields = ['id', 'receipt_date', 'agency', 'agency_name', 'user', 'user_name', 'total_amount', 'created_at', 'details']
...
class IssueSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Issue
        fields = ['id', 'issue_date', 'agency', 'agency_name', 'user', 'user_name', 'total_amount', 'created_at', 'details']
